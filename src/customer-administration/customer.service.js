...
// customer service
(function(configureCustomerServiceProvider) {
  configureCustomerServiceProvider('customerService', customerService);
...
})(angular.module('customerAdministration').provider);
